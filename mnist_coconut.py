...
from train_mnist_simple import VisionTransformer, PatchEmbedding, MultiHeadAttention, TransformerBlock
...
class MNISTCoconut(nn.Module):
    ...
    def __init__(
        ...
        self.special_embeddings = nn.Embedding(4, self.embed_dim)  # latent, start, end, eos
    ...
    def forward(self, images, reasoning_sequence=None, labels=None, **kwargs):
        ...
        if reasoning_sequence is not None:
            ...
            # Inference mode - just classify the image
    ...
    def _forward_with_reasoning(self, images, reasoning_sequence, labels=None):
        ...
        batch_size = images.shape[0]
        seq_len = reasoning_sequence.shape[1]
    ...
    def _get_sequence_embeddings(self, reasoning_sequence, image_features):
        ...
        for i in range(seq_len):
            ...
            for b in range(batch_size):
                ...
                if token_id == self.latent_token_id:
                ...
                elif token_id == self.start_latent_id:
                    ...
                    sequence_embeds[b, i] = self.special_embeddings(torch.tensor(3, device=reasoning_sequence.device))
                else:
                    # Regular token - use special embedding for now
    ...
    def generate(self, images, max_reasoning_steps=3):
